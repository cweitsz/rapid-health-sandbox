...
export default function SprintB() {
  ...
  return (
    <main style={page}>
      ...
      <h1 style={h1}>Sprint B: Quantify &amp; Test</h1>

      <p style={lead}>
        Goal: pick measurable indicators, define how you could be wrong, then validate the problem with real users.
      </p>
      ...
      <section style={card}>
        ...
        <div style={stepList}>
          <Link href={stepHref("1-4")} style={stepBtnStyle}>
            1.4 Measurable Indicators →
          </Link>
          <Link href={stepHref("1-5")} style={stepBtnStyle}>
            1.5 Disconfirming Hypotheses →
          </Link>
          <Link href={stepHref("1-6")} style={stepBtnStyle}>
            1.6 Problem Validation Interviews/Observation →
          </Link>
        </div>
      </section>
