...
export default function SprintC() {
  ...
  return (
    <main style={page}>
      ...
      <h1 style={h1}>Sprint C: Synthesize &amp; Decide</h1>

      <p style={lead}>
        Goal: turn evidence into a decision: Go, one iteration, or stop. No “maybe”.
      </p>
      ...
      <section style={card}>
        ...
        <div style={stepList}>
          <Link href={stepHref("1-7")} style={stepBtnStyle}>
            1.7 Before/After &amp; Solution Hypothesis →
          </Link>
          <Link href={stepHref("1-8")} style={stepBtnStyle}>
            1.8 Alternatives Scan →
          </Link>
          <Link href={stepHref("1-9")} style={stepBtnStyle}>
            1.9 Value Hook →
          </Link>
          <Link href={stepHref("1-10")} style={stepBtnStyle}>
            1.10 Gate Review →
          </Link>
        </div>
      </section>
